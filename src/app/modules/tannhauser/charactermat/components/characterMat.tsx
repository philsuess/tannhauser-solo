...
import * as CharacterMatStyle from '../style.css';
...
export default class CharacterMat extends React.Component<Model.CharacterData,CharacterMatState> {
  ...
  drawCard() {
    ...
    const new_draw_deck = this.state.draw_deck;
    new_draw_deck.splice(randomCardIndex, 1);
    this.setState({
      ...this.state,
      draw_deck: new_draw_deck,
      drawn_card: draw,
    });
  }
  ...
  render() {
    ...
    return (
      <div className={CharacterMatStyle.charactermat} style={VariableCharacterMatStyle} >
        <div>
          <img src={this.props.image} width={MatConstants.character_image_width} />
